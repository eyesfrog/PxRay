...
World::build(void) {
 ...
 RGBColor yellow(a * 1, a * 1, 0);
 RGBColor brown(0.71, 0.40, 0.16);
 RGBColor dark_green(0.0, 0.41, 0.41);
 RGBColor orange(a * 1, a * 0.75, 0);
 RGBColor green(0, 0.6, 0.3);
 RGBColor light_green(a * 0.65, a * 1, a * 0.30);
 ...
 sphere_ptr12->set_material(phong_ptr12);
